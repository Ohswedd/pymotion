...
**NEVER include Claude, AI assistants, or any automated tool as author or co-author in git commits.** This applies to all commits — past, present, and future. No `Co-Authored-By`, no `Generated by`, no AI attribution of any kind in commit messages, commit trailers, or commit metadata. All commits must appear as solely human-authored.
