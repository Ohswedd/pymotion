...
def main() -> None:
    ...
    img10.add_effect(pm.LensFlare(position=pm.Vec2(0.7, 0.3), intensity=0.9, color="#FFE6B3"))
    img10.add_effect(pm.LensFlareLight(position=pm.Vec2(0.3, 0.4), intensity=0.7, color="#FFF2CC"))
    img10.add_effect(pm.Bloom(radius=12.0, strength=0.6, threshold=180.0, iterations=4))
